      ...
      >
        ...
        >
          ...
          {lang ? (
            ...
            <Typography color={"gold"} sx={{ mt: "22px" }}>
              Czy potrzebujesz nowej strony internetowej, która spełni Twoje cele biznesowe? Twoja strona powinna
              działać sprawnie i wyróżniać się na tle konkurencji? To dokładnie rodzaj projektów, które
              tworzę.
            </Typography>
          )}
          {lang ? (
          ...
          >
            {lang ? <Typography variant="subtitle1">Contact via e-mail</Typography> : <Typography variant="subtitle1">Contact via e-mail</Typography>}
          </Button>
        </Box>
        <Box
          sx={{
