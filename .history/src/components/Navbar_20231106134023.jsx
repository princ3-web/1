  ...
  return (
    <>
      ...
      >
        ...
        <Box sx={{ display: "flex" }}>
          <Typography color={grey[100]} sx={{ fontWeight: 900, fontSize: 16 }} onClick={() => toggleLang(false)}>
            PL
          </Typography>
          <Typography color={grey[100]} sx={{ fontWeight: 900, fontSize: 16, mx:"0.25rem" }}>
          |
          </Typography>
          <Typography color={grey[100]} sx={{ fontWeight: 900, fontSize: 16 }} onClick={() => toggleLang(true)}>
            ENG
          </Typography>
        </Box>
      </Box>
