  ...
  return (
    <>
      ...
      >
        ...
        <Box sx={{ display: "flex" }}>
          <Typography color={grey[100]} sx={{ fontWeight: 900, fontSize: 20 }}>
            PL
          </Typography>
          <Typography color={grey[100]} sx={{ fontWeight: 900, mx:"0.25rem" }}>
          |
          </Typography>
          <Typography color={grey[100]} sx={{ fontWeight: 900 }}>
            ENG
          </Typography>
        </Box>
      </Box>
