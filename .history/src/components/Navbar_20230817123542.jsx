    ...
    <>
      ...
      >
        ...
        <Box sx={{ display: "flex", alignItems:"center" }}>
          <Box sx={{display: "flex", alignItems:"center" , p: 0.75, border: "1px solid" + grey[600], mr: 1, borderRadius: 2 }}>
            <GitHubIcon sx={{ color: teal[400], fontSize: 20 }} />
          </Box>
          <Box sx={{display: "flex", alignItems:"center" , p: 0.75, border: "1px solid" + grey[600], borderRadius: 2 }}>
