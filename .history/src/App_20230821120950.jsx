...
const StartContainer = () => {
  const texts = [
    "Hi, I'm Michael",
    "Crafting custom websites",    "Transforming visions into reality, our skilled web developer meticulously crafts custom websites that reflect your unique identity and captivate online audiences."
        ...
        >
          <Box sx={{ display: "flex", alignItems:"center" }}>
            ...
            <CardMedia
              ...
              image={gif0}
              alt="Sample Image"
              sx={{ height: "40px", width: "40px", objectFit: "contain", mx: 1 }}
            />
          </Box>
