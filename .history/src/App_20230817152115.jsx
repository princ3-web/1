          ...
          <Box sx={{ display: "flex", position: "relative", height: "100%" }}>
            ...
            >
              ...
              >
                ...
                <Box>
                  <Typography sx={{ color: grey[100], fontWeight: 600 }} variant="subtitle1">MUI Core</Typography>
                  <Typography sx={{ color: grey[500] }}>
                    Foundational components for shipping features faster. Includes Material UI.
                  </Typography>
                  <Typography sx={{ color: teal[400] }}>Learn more</Typography>
                </Box>
              </Box>
            </Box>
            <Box
