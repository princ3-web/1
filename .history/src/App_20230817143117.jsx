      ...
      <LocalizationProvider dateAdapter={AdapterDayjs}>
        ...
        <MainContainer height={"669px"}>
          <Box sx={{ display: "flex", position: "relative", height: "100%" }}>
            ...
            >
              <Typography sx={{ color: teal[400], fontWeight: 600}}>Products</Typography>
              <Typography variant="h4" sx={{ color: grey[100], fontWeight: 600}}>Every component you need is ready for production</Typography>
              <Typography sx={{ color: teal[400], fontWeight: 600}}>
