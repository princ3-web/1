  ...
  return (
    <MainContainer height={isMobile ? "auto" : "auto"}>
      ...
      >
        ...
        >
          <Box>
            {lang ? <Typography sx={{ color: "gold", fontWeight: 600, mb: 1 }}>Website projects</Typography> : <Typography sx={{ color: "gold", fontWeight: 600, mb: 1 }}>Website projects</Typography>}
            {lang ? (
