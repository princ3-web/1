...
import { grey, blueGrey, gree } from "@mui/material/colors";
    ...
    <>
      ...
      <MainContainer>
        <Box sx={{ display: "flex" }}>
          ...
          >
            <Typography variant="h3" fontWeight={600} color={blueGrey[600]}>Move faster with intuitive React UI tools</Typography>
            <Typography>
