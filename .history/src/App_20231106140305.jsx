      ...
      >
        ...
        >
          <Box>
            ...
            {lang ? <Typography sx={{ color: grey[400], fontWeight: 400, mt: 2 }}>
              Here is my collection of websites projects.
            </Typography> : <Typography sx={{ color: grey[400], fontWeight: 400, mt: 2 }}>
  ...
  return (
    <MainContainer height={"462px"}>
      ...
      >
        ...
        >
          {L<<Typography sx={{ color: "gold", fontWeight: 600, mb: 1 }}>Start now</Typography>
          <Typography variant="h4" sx={{ color: grey[200], fontWeight: 600 }}>
