          ...
          {items.map((item, n) => (
            <Box
              ...
              sx={{
                ...
                outline: selectedItem === n ? "2px solid" + teal[500] : "2px solid" + teal[500] + "20",
                transition: "0.2s",
              }}
            >
              <Box sx={{ m: 3 }}>
...
const SkillsContainer = () => {
  ...
  const items = [
    ...
    {
      title: "Google's Material Design system",
      text: "The easy way to message your group.",
    },
    {
    ...
    },
    {
      ...
      text: "Efficient management and tracking of changes to project codebase, collaboration with team members, and maintain version history",
    },
    {
      title: "Text-em-all 5",
      text: "The easy way to message your group.",
    ...
    <MainContainer>
      ...
      >
        <Box sx={{ boxSizing: "border-box", pl: "180px", pt: "100px", width: "773px" }}>
          <Box>
            <Typography sx={{ color: teal[500], fontWeight: 600, mb: 1 }}>Spectrum of possibilities</Typography>
