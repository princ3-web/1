        ...
        >
          ...
          {lang ? (
            <Typography color={"gold"} sx={{ mt: "22px" }}>
              Do you need a new website that will be an attractive showcase for your company? Do you want your website to function smoothly and stand out from the competition? Do you need a landing page, an e-commerce site for your store, or a more advanced website? Write to us!
            </Typography>
          ) : (
