...
const DesignContainer = ({ isMobile }) => {
  ...
  return (
    <MainContainer height={isMobile ? "auto" : "654px"}>
      <Box
        sx={{
          display: "flex",
      ...
      >
        ...
        >
          ...
          >
            {items.map((item, n) => (
              <Box sx={{ width: "31%", height: "300px", overflow: "hidden", m: "0.765%", mt: n%2 === 0 && "50px" }}>
                <CardMedia component="img" image={item.image} alt="Sample Image" sx={{}} />
              </Box>
            ))}
          </Box>
        </Box>
