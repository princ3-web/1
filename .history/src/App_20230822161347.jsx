...
const SkillsContainer = () => {
  ...
  const items = [
    ...
    {
      title: "powerful version control system known for its distributed architecture, efficient branching and merging capabilities, and strong collaboration features, enabling teams to manage code changes seamlessly and maintain a reliable history of their projects.",
