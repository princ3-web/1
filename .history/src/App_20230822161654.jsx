...
const SkillsContainer = () => {
  ...
  const items = [
    ...
    },
    {
      ...
      text: "Collaborative design for UI/UX teams with real-time editing, while Canva offers a simplified platform for creating graphics and visuals without extensive design skills.",
    },
    {
      title: "Text-em-all 6",
