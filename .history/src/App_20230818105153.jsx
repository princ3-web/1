          ...
          <MainContainer>
            ...
            >
              <Box>
                ...
                <Box sx={{ boxSizing: "border-box", pl: "180px", mt: "37px", width: "50vw" }}>
                <Typography variant="h6" sx={{ color: teal[500], fontWeight: 600, mb: 1 }}>
                  Skills
                  </Typography>
                </Box>
              </Box>
              <Box>
                <Box sx={{width: "300px", height: "600px", backgroundColor: teal[600]}}></Box>
              </Box>
            </Box>
          </MainContainer>
