    ...
    <MainContainer height={isMobile ? "auto" : "954px"}>
      ...
      >
        ...
        >
          ...
          <Box sx={{ display:"flex", flexDirection:"row", flexWrap:"wrap", border: "5px solid red", justifyContent:"center" }}>
            {items.map((item) => (
              <Box sx={{width: "33.3%", height: "300px", overflow:"hidden", outline:"1px solid red"}}>
                <CardMedia
                  component="img"
                  image={item.image}
                  alt="Sample Image"
                  sx={{ objectFit: "cover", mx: 2 }}
                />
              </Box>
            ))}
          </Box>
