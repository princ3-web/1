...
const StartContainer = ({ isMobile }) => {
  ...
  const settings = {
    ...
    particle: {
      particleCount: 100,
      color: theme.palette.customTeal[300],
      minSize: 1,
      maxSize: 5,
    },
    velocity: {
    ...
    <MainContainer height={"684px"}>
      <Box
        sx={{
          ...
          background: "linear-gradient(" + theme.palette.customTeal[900] + "," + theme.palette.customTeal[600] + ")",
        }}
      >
  ...
  return (
    <MainContainer height={isMobile ? "auto" : "auto"}>
      ...
      >
        ...
        >
          <Box>
            <Typography sx={{ color: theme.palette.customTeal[300], fontWeight: 600, mb: 1 }}>
              Website projects
            </Typography>
            <Typography variant="h4" sx={{ color: grey[100], fontWeight: 600 }}>
              Check my website projects
            </Typography>
            <Typography variant="h4" sx={{ color: theme.palette.customTeal[300], fontWeight: 600 }}>
    ...
    <MainContainer height={isMobile ? "auto" : "954px"}>
      ...
      >
        ...
        >
          ...
          <Box>
            <Typography variant="h5" sx={{ color: theme.palette.customTeal[300], fontWeight: 600, mb: 1, mt: 3 }}>
              Skills
            </Typography>
              ...
              {items.map((item, n) => (
                <Box
                  ...
                  sx={{
                    ...
                    outline:
                      selectedItem === n ? "2px solid" + theme.palette.customTeal[300] : "2px solid" + theme.palette.customTeal[300] + "20",
                    transition: "0.2s",
                  }}
                >
                  <CardMedia
  ...
  return (
    <MainContainer height={"462px"}>
      ...
      >
        ...
        >
          <Typography sx={{ color: theme.palette.customTeal[300], fontWeight: 600, mb: 1 }}>Start now</Typography>
          <Typography variant="h4" sx={{ color: grey[200], fontWeight: 600 }}>
          ...
          <Button
            ...
            sx={{
              color: grey[100],
              background: "linear-gradient(to bottom," + theme.palette.customTeal[300] + "," + theme.palette.customTeal[300] + ")",
              mt: 2,
              textTransform: "none",
              borderRadius: 2,
              px: 2,
