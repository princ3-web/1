  ...
  return (
    <MainContainer>
      ...
      >
        ...
        >
          <Box>
            <Typography sx={{ color: blue[400], fontWeight: 600, mb: 1 }}>Demos</Typography>
            <Typography variant="h4" sx={{ color: grey[100], fontWeight: 600 }}>
              Check my project demos
            </Typography>
            <Typography variant="h4" sx={{ color: blue[400], fontWeight: 600 }}>
          ...
          {items.map((item, n) => (
            <Box
              ...
              sx={{
                ...
                borderRadius: 2,
                cursor: "pointer",
                backgroundColor: selectedItem === n ? blue[900] + 30 : "none",
                outline:
                  selectedItem === n ? "2px solid" + blue[500] : "2px solid" + blue[500] + "20",
                transition: "0.2s",
              }}
            >
              <Box sx={{ m: 3 }}>
                <GitHubIcon sx={{ fontSize: 40, color: blue[500] }} />
              </Box>
              <Box>
                ...
                <Typography sx={{ color: blue[400], fontWeight: 600 }} variant="subtitle2">
                  Learn more
                </Typography>
              </Box>
            </Box>
    ...
    <MainContainer>
      ...
      >
        <Box sx={{ boxSizing: "border-box", pl: "180px", pt: "116px", width: "773px" }}>
          <Box>
            <Typography sx={{ color: blue[500], fontWeight: 600, mb: 1 }}>
          ...
          <Box>
            <Typography variant="h5" sx={{ color: blue[500], fontWeight: 600, mb: 1, mt: 3 }}>
              Skills
            </Typography>
    ...
    <MainContainer height={"462px"}>
      ...
      >
        <Box sx={{ boxSizing: "border-box", pl: "180px", pt: "100px", width: "50vw" }}>
          <Typography sx={{ color: blue[500], fontWeight: 600, mb: 1 }}>Start now</Typography>
          <Typography variant="h4" sx={{ color: grey[200], fontWeight: 600 }}>
          ...
          <Button
            sx={{
              color: grey[100],
              background: "linear-gradient(to bottom," + blue[400] + "," + blue[600] + ")",
              mt: 2,
              textTransform: "none",
              borderRadius: 2,
              px: 2,
