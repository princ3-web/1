...
const SkillsContainer = () => {
  ...
  const items = [
    ...
    },
    {
      ...
      text: "Creat visually consistent and intuitive user interfaces by following its design principles, using its pre-built components, and leveraging its guidelines for layout, typography, and color.",
    },
    {
