      ...
      >
        ...
        >
          ...
          {lang ? (
            ...
            <Typography color={"gold"} sx={{ mt: "22px" }}>
              Czy chcesz stronę internetową, która spełni Twoje cele biznesowe? Twoja strona powinna
              działać sprawnie i wyróżniać się na tle konkurencji? To dokładnie rodzaj stron, które
              projektuję.
            </Typography>
          )}
          {lang ? (
            ...
            <>
              <Typography color={grey[200]} sx={{ mt: "22px" }}>
                - Bardzo szybkie zarówno na komputerach, jak i telefonach
              </Typography>
              <Typography color={grey[200]} sx={{ mt: "12px" }}>
        ...
        >
          {lang ?
            <>
             ...
             <Typography sx={{ color: grey[500], mt: 1 }}>
             Skontaktuj się z nami przez czat lub e-mail aby omówić Twój nowy projekt. Oferujemy niezobowiązującą wycenę projektu.
             </Typography>
           </>  
          }
