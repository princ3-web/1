        ...
        <ThemeProvider theme={theme}>
          ...
          <MainContainer>
            <Box>
              ...
              <Typography>Ship your next project faster</Typography>
              <Typography>Find out why MUI's tools are trusted by thousands of open-source developers and teams around the world.</Typography>
              <Button>Discover core l</Button>
            </Box>
            <Box></Box>
          </MainContainer>
          <MainContainer />
