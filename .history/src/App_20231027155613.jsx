...
const StartContainer = ({ isMobile }) => {
  ...
  const settings1 = {
    ...
    particle: {
      particleCount: 100,
      color: theme.palette.customTeal[500],
      minSize: 1,
      maxSize: 5,
    },
    velocity: {
  ...
  const settings2 = {
    ...
    particle: {
      particleCount: 100,
      color: theme.palette.customTeal[100],
      minSize: 1,
      maxSize: 5,
    },
    velocity: {
  ...
  const particlesArray = [settings1, settings2];
    ...
    <MainContainer height={"684px"}>
      ...
      >
        <Box sx={{ position: "absolute", height: "100%", width: "100vw" }}>
          <ParticleBackground settings={particlesArray[0]} />
          <ParticleBackground settings={particlesArray[1]} />
        </Box>
        <Box
          sx={{
        ...
        >
          <Typography variant="h3" fontWeight={600} color={theme.palette.customTeal[200]}>
      ...
      >
        ...
        >
          ...
          <Box>
            <Typography
              variant="h5"
              sx={{ color: theme.palette.customTeal[300], fontWeight: 600, mb: 1, mt: 3 }}
            >
              Skills
            </Typography>
