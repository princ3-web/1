          ...
          <Box sx={{ display: "flex", position: "relative", height: "100%" }}>
            ...
            >
              ...
              >
                ...
                <Box>
                  <Typography sx={{color: grey[100]}}>MUI Core</Typography>
                  <Typography sx={{color: grey[500]}}>Foundational components for shipping features faster. Includes Material UI.</Typography>
                  <Typography sx={{color: teal[400]}}>a</Typography>
                </Box>
              </Box>
            </Box>
            <Box
