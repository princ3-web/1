      ...
      <MainContainer>
        <Box sx={{ display: "flex" }}>
          ...
          >
            ...
            <Typography variant="h3" fontWeight={600} color={teal[400]}>with intuitive React UI tools</Typography>
            <Typography variant="h3" fontWeight={600} color={teal[400]}>React UI tools</Typography>
            <Typography>
