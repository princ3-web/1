        ...
        >
          ...
          >
            <CardMedia
              ...
              alt="Sample Image"
              sx={{ boxSizing: "border-box", objectFit: "cover", objectPosition: "0 0" }}
            />
          </Box>
        </Box>
      </Box>
  ...
  const items = [
    {
      ...
      text: "The React JS library can be utilized to create interactive and responsive user interfaces for web applications by building modular components that efficiently handle data changes and updates.",
    },
    {
      title: "Google's Material Design",
      text: "Creation visually consistent and intuitive user interfaces by following its design principles, using its pre-built components, and leveraging its guidelines for layout, typography, and color.",
    },
    {
      title: "Visual Studio Code software",
      text: "Most convenient and verstatile code editor.",
    },
    {
          ...
          <Box>
            ...
            <Box sx={{ display: "flex", flexWrap: "wrap" }}>
              {items.map((item, n) => (
                ...
                >
                  <Box sx={{ m: 2 }}>
                    <GitHubIcon sx={{ color: teal[500], fontSize: 40 }} />
                  </Box>
                  <Box>
