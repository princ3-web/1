              ...
              <Box
                sx={{
                  ...
                  "&:hover": {
                    transform:
                      n % 3 === 1
                        ? "scale(1.1) translate(0%, 15%)"
                        : "scale(1.1) translate(0%, 0%)",
                  },
                }}
              >
                <Box sx={{width:"100%", height:"100%", backgroundColor:"transparent"}}></Box>
                <CardMedia component="img" image={item.image} alt="Sample Image" sx={width:"100%", height:"100%"} />
              </Box>
            ))}
          </Box>
        </Box>
