      ...
      >
        <Box
          sx={{
            ...
            height: "100%",
            pl: isMobile ? "20px" : "180px",
            pr: isMobile ? "20px" : "124px",
            pt: "136px",
          }}
        >
      ...
      >
        <Box
          sx={{
            width: "773px",
            height: "100%",
            pl: isMobile ? "40px" : "180px",
            pr: isMobile ? "40px" : "90px",
            pt: "116px",
            boxSizing: "border-box",
          }}
        >
...
const SkillsContainer = ({ isMobile }) => {
  ...
  return (
    <MainContainer>
      ...
      >
        <Box sx={{ boxSizing: "border-box", pl: isMobile ? "40px" : "180px", pt: "116px", width: "773px" }}>
          <Box>
