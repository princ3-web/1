      ...
      <LocalizationProvider dateAdapter={AdapterDayjs}>
        <ThemeProvider theme={theme}>
          ...
          <MainContainer height={"669px"}>
            <Box sx={{ display: "flex", position: "relative", height: "100%", backgroundColor: theme.palette.customTeal[800] }}>
              <Box
                sx={{
          ...
          <MainContainer>
            <Box sx={{ display: "flex", position: "relative", height: "100%", backgroundColor theme.palette.customTeal[900] }}>
              <Box
                sx={{
                  width: "50vw",
                  height: "100%",
